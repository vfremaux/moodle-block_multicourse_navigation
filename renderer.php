...
class block_multicourse_navigation_nav_renderer extends plugin_renderer_base {

    public function render_nav($template) {
        return $this->render_from_template('block_multicourse_navigation/coursenav', $template);
    }
